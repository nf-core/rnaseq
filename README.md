...
1. Install [`Nextflow`](https://nf-co.re/usage/installation) (`>=21.04.0-edge`). At the time of release, this version of the pipeline requires an `edge` release of Nextflow (see [usage docs](https://nf-co.re/rnaseq/usage#nextflow-edge-releases) for more information).
