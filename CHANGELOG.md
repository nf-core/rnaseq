...
- [PR #1740](https://github.com/nf-core/rnaseq/pull/1740) - Always set ID/SM read group tags for STAR and HISAT2 even when `seq_center`/`seq_platform` are not provided
