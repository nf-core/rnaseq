...
def fasta2gtf(fasta, output):
    ...
    # GTF output lines
    lines = []
    attributes = 'gene_id "{name}_transgene"; gene_name "{name}_transgene"; transcript_id "{name}_transgene"; gene_biotype "{name}_transgene"; gene_type "{name}_transgene"\n'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="""Convert a custom fasta (e.g. transgene) to a GTF annotation.""")
    parser.add_argument("fasta", type=str, help="Custom transgene sequence")
    parser.add_argument("-o", "--output", dest='output', default='transgenes.gtf', type=str, help="gene annotation GTF output")
