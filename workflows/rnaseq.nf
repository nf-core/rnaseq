...
include { BAM_SORT_SAMTOOLS          } from '../subworkflows/nf-core/bam_sort_samtools/main'     addParams( sort_options: modules['samtools_sort_transcriptome'], index_options: modules['samtools_index_transcriptome'], stats_options: modules['samtools_index_transcriptome']      )
