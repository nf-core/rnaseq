...
* The BAM files generated by `--aligner star` and `--aligner hisat2` will now be quantified using Salmon instead of featureCounts. This decision was made primarily because of the limitations of featureCounts to appropriately quantify gene expression data.
