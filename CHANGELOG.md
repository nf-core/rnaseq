...
- [PR #XXXX](https://github.com/nf-core/rnaseq/pull/XXXX) - Remove redundant UNTAR version collection, use `sanitizeOutput` in Parabricks tests, fix .nftignore to reinstate tx2gene MD5 checking
