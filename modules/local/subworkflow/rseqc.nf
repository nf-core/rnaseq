...
include { RSEQC_BAMSTAT            } from '../process/rseqc_bamstat'
include { RSEQC_INNERDISTANCE      } from '../process/rseqc_innerdistance'
include { RSEQC_INFEREXPERIMENT    } from '../process/rseqc_inferexperiment'
include { RSEQC_JUNCTIONANNOTATION } from '../process/rseqc_junctionannotation'
include { RSEQC_JUNCTIONSATURATION } from '../process/rseqc_junctionsaturation'
include { RSEQC_READDISTRIBUTION   } from '../process/rseqc_readdistribution'
include { RSEQC_READDUPLICATION    } from '../process/rseqc_readduplication'
