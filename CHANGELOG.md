...
- [PR #1709](https://github.com/nf-core/rnaseq/pull/1709) - Update metro map renders with nf-metro v0.4.4; add source `.mmd` file and regeneration instructions to CONTRIBUTING.md
