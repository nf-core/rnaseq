...
curl https://export.uppmax.uu.se/b2013064/test-data/ngi-rna_test_set.tar.bz2 > /tmp/ngi-rna_test_set.tar.bz2
echo "Done"
...
nextflow run $script_path -profile docker_test --aligner hisat2 --reads '/tmp/ngi-rna_test_set/*.fastq.gz'
