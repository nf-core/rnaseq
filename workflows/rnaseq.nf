...
include { DEXSEQ_ANNOTATE                    } from '../modules/local/dexseq_annotate'             addParams( options: modules['dexseq_annotate']                        )
include { DEXSEQ_COUNT                       } from '../modules/local/dexseq_count'                addParams( options: modules['dexseq_count']                           )
