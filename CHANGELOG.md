...
- [PR #1776](https://github.com/nf-core/rnaseq/pull/1776) - Clarify MultiQC "Proper Pairs" column labels to distinguish RSeQC bam_stat (MAPQ >= 30 only) from samtools stats (all reads)
