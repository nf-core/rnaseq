...
process featureCounts {
    ...
    """
    featureCounts -a $gtf -g ${params.fcGroupFeatures} -o ${bam_featurecounts.baseName}_gene.featureCounts.txt $extraAttributes -M -p -s $featureCounts_direction $bam_featurecounts
    featureCounts -a $gtf -g ${params.fcGroupFeaturesType} -o ${bam_featurecounts.baseName}_biotype.featureCounts.txt -M -p -s $featureCounts_direction $bam_featurecounts
