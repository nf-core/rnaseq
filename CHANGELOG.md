...
- [PR #1773](https://github.com/nf-core/rnaseq/pull/1773) - Clarify MultiQC "Proper Pairs" column labels to distinguish RSeQC bam_stat (MAPQ >= 30 only) from samtools stats (all reads)
