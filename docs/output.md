...
* `salmon/`
  ...
  * `salmon.merged.gene_tpm_scaled.tsv`: Matrix of gene-level scaled TPM values across all samples.
  ...
  * `salmon.merged.gene_tpm_length_scaled.tsv`: Matrix of gene-level length-scaled TPM values across all samples.
