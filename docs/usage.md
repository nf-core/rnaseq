...
For example, the pipeline may fail after multiple re-submissions of the `STAR_ALIGN` process due to an exit code of `137` as shown below which indicates that there is an out of memory issue:
