...
- [PR #1687](https://github.com/nf-core/rnaseq/pull/1687) - Fix PREPARE_GENOME test coverage: use single aligner values, correct aligner assignments for index-specific tests, add Kallisto index test
