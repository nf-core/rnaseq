...
> **NB:** STAR is fast but requires a lot of memory to run, typically around 38GB for the Human GRCh37 reference genome. If you have memory limitations wherever you are trying to run the pipeline HISAT2 may be a more suitable option but with the caveats mentioned above.
