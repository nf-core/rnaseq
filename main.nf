...
if (compressedReference) {
  ...
  if (params.gtf) {
    process gunzip_gtf {
        ...
        output:
        file "${gz.baseName}" into ch_genome_gtf, gtf_makeSTARindex, gtf_makeHisatSplicesites, gtf_makeHISATindex, gtf_makeSalmonIndex, gtf_makeBED12,
...
if ( params.additional_fasta ){
  ...
  process combine_genome_annotations {
    ...
    """
      ...
      ch_genome_fasta.into { ch_fasta_for_star_index; ch_fasta_for_hisat_index; ch_fasta_for_salmon_transcripts}
